  ...
  <head>
    ...
    <?php
        ...
        $row = mysqli_fetch_assoc($query);
                ...
                $avatar=$row['avatar'];
        require("connect.php");
        mysqli_query($con,"Update member SET lastread='Maths' WHERE username='$dbuser'");
        mysqli_query($con,"Update member SET lasturl='ece/1/math.php' WHERE username='$dbuser'");
        ?>
    ...
    <div class="container-fluid" id="subject1">
      <div class="hidden-xs hidden-sm">
            <div class="jumbotron" class="hidden-xs" class="hidden-sm" style="margin-left:250px;background-color:#AA01B6;height:200px;margin-bottom:10px;">
              <h2 style="color:white;margin-top:50px;">Maths <br>
